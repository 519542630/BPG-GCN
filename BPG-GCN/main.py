...
class Processor():
    ...
    def train(self, epoch, save_model=False, isDone=False):
        self.model.train()
        ...
        # forward
        if epoch < 65:
            keep_prob = -(1 - self.arg.keep_rate) / 65 * epoch + 1.0
        else:
        ...
        for batch_idx, (data, label, index) in enumerate(process):
            ...
            #loss_mse_value.append(loss_mse.data.item())
    ...
    def eval(self, epoch, save_score=False, loader_name=['test'], wrong_file=None, result_file=None):
        ...
        for ln in loader_name:
            ...
            #loss_mse = np.mean(loss_mse_value)
    ...
    def start(self):
        if self.arg.phase == 'train':
            ...
            for epoch in range(self.arg.start_epoch, self.arg.num_epoch):
                ...
                isDone = self.train(epoch, save_model=save_model, isDone=isDone)
            ...
            #niium_params = sum(p.numel() for p in self.model.parameters() if p.requires_grad)
